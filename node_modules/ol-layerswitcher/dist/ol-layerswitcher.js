    ...
    */
    ...
    createClass(LayerSwitcher, [{
        ...
        */
		...
		/**modifiche al SET Visibility**/
						key: 'setVisibleGroup_',
						value: function setVisibleGroup_(map, lyr, visible) {
							lyr.setVisible(visible);
							if (visible && lyr.get('type') === 'base') {
								// Hide all other base layers regardless of grouping
								LayerSwitcher.forEachRecursive(map, function (l, idx, a) {
		...
		/****/
		/***
		Tentativo di modifica della funzione SetVisible in modo da permettere di selezionare e deselezionare 
		***/
    }, {
        key: 'renderLayer_',
            ...
            if (lyr.getLayers && !lyr.get('combine')) {
				...
				var input1 = document.createElement('input');
							...
							input1.onchange = function (e) {
								LayerSwitcher.setVisibleGroup_(map, lyr, e.target.checked);
							};
